...
public class CharacterModifyService {
    ...
    Map<String, BiConsumer<Characters, Object>> characterSetters =
            Map.of(
                    ...
                    "experience points",
                            (c, v) -> c.setExperiencePoints(Integer.parseInt(v.toString())),
    ...
    public CharacterModifyService(CharacterRepository characterRepository) {
        ...
        this.modificationSteps =
                List.of(
                        new SelectEntityStepHandler<Characters>(
                                characterRepository::findByCharacterName),
                        new ChooseFieldStepHandler<Characters>(
                                name -> characterRepository.findByCharacterName(name),
                                characterSetters),
                        new UpdateFieldStepHandler<Characters>(
                                characterRepository::save, characterSetters));
    }
