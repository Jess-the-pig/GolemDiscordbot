...
public class MonsterModifyService {
    ...
    Map<String, BiConsumer<Monsters, Object>> monsterSetters =
            Map.ofEntries(
                    Map.entry(
                            "name", (BiConsumer<Monsters, Object>) (m, v) -> m.setName((String) v)),
                    ...
                    Map.entry(
                            "type", (BiConsumer<Monsters, Object>) (m, v) -> m.setType((String) v)),
                    Map.entry(
                            "size", (BiConsumer<Monsters, Object>) (m, v) -> m.setSize((String) v)),
                    Map.entry(
                            "ac",
                            (BiConsumer<Monsters, Object>)
                                    (m, v) -> m.setAc(Integer.parseInt(v.toString()))),
                    Map.entry(
                            "hp",
                            (BiConsumer<Monsters, Object>)
                                    (m, v) -> m.setHp(Integer.parseInt(v.toString()))),
                    Map.entry(
                            "speed",
                            (BiConsumer<Monsters, Object>) (m, v) -> m.setSpeed((String) v)),
                    Map.entry(
                            "align",
                            (BiConsumer<Monsters, Object>) (m, v) -> m.setAlign((String) v)),
                    Map.entry(
                            "legendary",
                            (BiConsumer<Monsters, Object>) (m, v) -> m.setLegendary((String) v)),
                    Map.entry(
                            "source",
                            (BiConsumer<Monsters, Object>) (m, v) -> m.setSource((String) v)),
                    Map.entry(
                            "strength",
                            (BiConsumer<Monsters, Object>)
    ...
    public MonsterModifyService(MonsterRepository monsterRepository) {
        ...
        this.modificationSteps =
                List.of(
                        ...
                        new UpdateFieldStepHandler<Monsters>(
                                monsterRepository::save, monsterSetters));
    }
