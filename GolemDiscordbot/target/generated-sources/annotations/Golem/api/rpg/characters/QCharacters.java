...
public class QCharacters extends EntityPathBase<Characters> {
    ...
    private static final long serialVersionUID = 431006995L;
    ...
    public final Golem.api.rpg.campaign.QCampaign campaign;
    ...
    public QCharacters(Class<? extends Characters> type, PathMetadata metadata, PathInits inits) {
        ...
        this.campaign = inits.isInitialized("campaign") ? new Golem.api.rpg.campaign.QCampaign(forProperty("campaign")) : null;
    }
