...
public class QTerrainMonster extends EntityPathBase<TerrainMonster> {
    ...
    private static final long serialVersionUID = 2140245784L;
    ...
    public final Golem.api.rpg.monsters.QMonsters monster;
    ...
    public QTerrainMonster(Class<? extends TerrainMonster> type, PathMetadata metadata, PathInits inits) {
        ...
        this.monster = inits.isInitialized("monster") ? new Golem.api.rpg.monsters.QMonsters(forProperty("monster")) : null;
